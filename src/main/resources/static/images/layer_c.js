...
lang['layer']={'data_max_select':'最多只能选择{max}项','save':'确定','cancel':'取消','all':'所有','no_data':'没有找到合适的结果','relation_keyword':'相关关键词','data_added':'你已经选择过该项了', 'select': '选择','self_define': '自定义'};
